  ...
  "fields": {
    "field": [{
      ...
      "value": [{
        ...
        "enum": "H",
        "description": "REINSTATE_ON_SYSTEM_FAILUE"
      }, {
        "enum": "I",
      ...
      "value": [{
        ...
        "enum": "D",
        "description": "NEW_ORDER_D"
      }, {
        "enum": "E",
        "description": "NEW_ORDER_E"
      }, {
        "enum": "F",
        ...
        "enum": "W",
        "description": "MARKET_DATA_W"
      }, {
        "enum": "X",
        "description": "MARKET_DATA_X"
      }, {
        "enum": "Y",
        ...
        "enum": "BC",
        "description": "NETWORK_COUNTERPARTY_SYSTEM_STATUS_REQUEST"
      }, {
        "enum": "BD",
        "description": "NETWORK_COUNTERPARTY_SYSTEM_STATUS_RESPONSE"
      }, {
        "enum": "BE",
      ...
      "value": [{
        "enum": "60",
        "description": "ONE_PARTY_PRIVATELY_NEGOTIATED_TRADE_REPORT"
      }, {
        "enum": "61",
        "description": "TWO_PARTY_PRIVATELY_NEGOTIATED_TRADE_REPORT"
      }, {
        "enum": "62",
        "description": "CONTINUOUS_AUTO_MATCH"
      }, {
        "enum": "63",
        "description": "CROSS_AUCTION_63"
      }, {
        "enum": "64",
        "description": "COUNTER_ORDER_SELECTION_64"
      }, {
        "enum": "65",
        "description": "CALL_AUCTION_65"
      }, {
        "enum": "M3",
        ...
        "enum": "5",
        "description": "CROSS_AUCTION_5"
      }, {
        "enum": "6",
        "description": "COUNTER_ORDER_SELECTION_6"
      }, {
        "enum": "7",
        "description": "CALL_AUCTION_7"
      }],
      "number": "574",
      "name": "MatchType",
      "type": "STRING"
      ...
      "value": [{
        ...
        "enum": "9",
        "description": "UNAUTHORIZED_ROR_TRADE_CAPTURE_REPORT_REQUEST"
      }, {
        "enum": "99",
        "description": "OTHER"
      }],
      ...
      "value": [{
        ...
        "enum": "4",
        "description": "NATIONAL_XXCLUDING_LOCAL"
      }],
      "number": "840",
      "name": "PegScope",
      "type": "INT"
      ...
      "value": [{
        "enum": "0",
        "description": "SECONDARYORDEID"
      }, {
        "enum": "1",
        "description": "ORDEID"
      }, {
        "enum": "2",
        "description": "MENTRYID"
      }, {
        "enum": "3",
        "description": "QUOTENTRYID"
      }],
      "number": "1081",
      "name": "RefOrderIDSource",
      "type": "CHAR"
